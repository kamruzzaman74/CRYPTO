    ...
    <section className="bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 text-white py-16 px-8 rounded-lg shadow-lg">
      <div className="container mx-auto text-center">
        <h2 className="text-5xl font-extrabold mb-6 animate__animated animate__fadeIn animate__delay-1s">
          Unlock Exclusive Discounts with ASI Tokens!
        </h2>
        ...
        <div className="flex justify-center gap-6">
          <button 
            className={`bg-yellow-500 hover:bg-yellow-600 text-black py-3 px-6 rounded-full text-xl font-semibold transform transition-all duration-300 ease-in-out hover:scale-105 animate__animated animate__fadeIn animate__delay-6s ${claimClicked ? 'bg-green-500' : ''}`} 
            onClick={handleClaimClick}
          >
            {claimClicked ? 'Discount Claimed!' : 'Claim Your Discount Now'}
          </button>
          <button className="bg-transparent border-2 border-white hover:bg-white hover:text-black py-3 px-6 rounded-full text-xl font-semibold transform transition-all duration-300 ease-in-out hover:scale-105 animate__animated animate__fadeIn animate__delay-7s">
        ...
        {claimClicked && (
          <div className="mt-12">
            <p className="text-xl font-semibold animate__animated animate__fadeIn animate__delay-8s">
